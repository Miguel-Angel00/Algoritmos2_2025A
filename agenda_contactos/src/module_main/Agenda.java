...
public class Agenda {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(nombreArchivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (partes.length == 4) {
                    ...
                    Contacto existente = new Contacto(nombre, ciudad, telefono, anioNacimiento);
    ...
    public void guardarContactosDesdeConsola(Scanner sc) {
    	...
    	Contacto nuevo = new Contacto(nombre, ciudad, telefono, anioNacimiento);
    	contactos.add(nuevo);
    	

    	try (BufferedWriter bw = new BufferedWriter(new FileWriter(nombreArchivo, true))){
    		String linea = nombre + ";" + ciudad + ";" + telefono + ";" + anioNacimiento + ";";
    		bw.write(linea);
    		bw.newLine();
